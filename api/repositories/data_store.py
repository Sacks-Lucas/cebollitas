...
cebollitas_matches_repo = _make_repo("cebollitas_matches")
...
_REPOS_BY_NAME = {
    ...
    "cebollitas_matches": cebollitas_matches_repo,
...
def get_cebollitas_matches() -> list[dict]:
    return cebollitas_matches_repo.read()
